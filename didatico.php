...
<div class="container-fluid">
<h3 class="text-center sub2 ">Livros Didatícos</h3> 
    <BR><BR>
<article class="col-md-12">       
<section class="col-md-3  ">  
    <a href="#">
    <img  src="imagem/livro_tempoPort.jpg" alt="Livro didatíco de português volume 7" class="  img-responsive"></a>
    </section>
 ...
 <?php
      ...
      $info = mysqli_query($conexao, "select * from cadastro_livro where cod_livro = '94'");
...
$limite = mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Didatico' limit $inicio, $visualizar");

// verifica a quantidade de registros
$todos =  mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Didatico'");

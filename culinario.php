...
<div class="container-fluid">
<h3 class="text-center sub2 ">Livros Culinários</h3> 
    <BR><BR>
<article class="col-md-12">       
<section class="col-md-3  ">
    <a href="#">
    <img  src="imagem/livro_culinaria.jpg" alt="Livro com diversas receitas  " class="  img-responsive"></a>
    </section>
 <section class="col-md-3  ">      
 <?php
      include_once('connection/conexao.php');

      $info = mysqli_query($conexao, "select * from cadastro_livro where cod_livro = '97'");
...
$limite = mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'culinaria' limit $inicio, $visualizar");

// verifica a quantidade de registros
$todos =  mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'culinaria'");

...
<div class="container-fluid">
<h3 class="text-center sub2 ">Livros Românticos</h3> 
    <BR><BR>
<article class="col-md-12">       
<section class="col-md-3  ">
    <a href="#">
    <img  src="imagem/o_encontro.jpg" alt="Livro romantico que conta a historia de um casal..." class="  img-responsive"></a>
    </section>
 <section class="col-md-3  ">      
  <?php
      include_once('connection/conexao.php');

      $info = mysqli_query($conexao, "select * from cadastro_livro where cod_livro = '85'");
...
$limite = mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Romance' limit $inicio, $visualizar");

// verifica a quantidade de registros
$todos =  mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Romance'");

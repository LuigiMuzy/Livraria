...
<section class="col-md-3  ">
 ...
 <section class="col-md-3  ">      
   <?php
      ...
      $info = mysqli_query($conexao, "select * from cadastro_livro where cod_livro = '16'");
...
$limite = mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Infantil' limit $inicio, $visualizar");

// verifica a quantidade de registros
$todos =  mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Infantil'");

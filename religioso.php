...
<div class="container-fluid">
<h3 class="text-center sub2 ">Livros Religiosos</h3> 
    <BR><BR>
<article class="col-md-12">       
<section class="col-md-3  ">
    <a href="#">
    <img  src="imagem/livro_religioso.jpg" alt="Livro 25 coisa que um cristão deveria ler ...." class="   img-responsive"></a>
    </section>
 ...
 <?php
      ...
      $info = mysqli_query($conexao, "select * from cadastro_livro where cod_livro = '93'");
...
<?php
      ...
      {?>
        ...
        <h4>Nome do Livro:<?php echo $dados['nome_livro']; ?></h4><BR>        
...
$limite = mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Religioso' limit $inicio, $visualizar");

// verifica a quantidade de registros
$todos =  mysqli_query($conexao, "select * from cadastro_livro  where categoria = 'Religioso'");
